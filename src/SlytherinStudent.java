public class SlytherinStudent extends HogwartsStudent {
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Student %s better than student %s: %d VS %d%n", getName(), slytherinStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("Student %s better than student %s: %d VS %d%n", getName(), slytherinStudent.getName(), ability2, ability1);
        }
        else{
            System.out.printf("Student %s same as a student %s: %d VS %d%n", getName(), slytherinStudent.getName(), ability2, ability1);
        }
    }
